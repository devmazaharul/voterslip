...
// ──────────────────────────────────────────────
// MAIN COMPONENT — DARK DASHBOARD STYLE
// ──────────────────────────────────────────────
const VoterSearchForm: React.FC = () => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        if (!centerId) return setError('কেন্দ্র তথ্য পাওয়া যায়নি।');
                ...
                <div className="w-full max-w-2xl">
                                    ...
                                    {centerId && (
                                        <div className="mt-2.5 flex items-center gap-2 pl-1 animate-[fadeIn_0.3s_ease]">
                                            ...
                                            <span className="text-[10px] text-gray-500 font-medium">
                                                কেন্দ্র আইডি:{' '}
                                                <span className="font-bold text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-md border border-emerald-500/10 ml-0.5 font-mono">
                    ...
                    <div className="flex items-center justify-center gap-3 mt-6 pb-2">
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-1.5 text-[10px] text-emerald-600 hover:text-gray-400 font-bold transition-colors"
                        >
